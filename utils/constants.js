...
export const constants = {
  ...
  UNLIMITED_ALLOWANCE_IN_BASE_UNITS: ethers.constants.MaxUint256,
  ...
  INFINITE_TIMESTAMP_SEC: BigNumber.from("2524604400"), // Close to infinite
  ZERO_AMOUNT: BigNumber.from("0"),
